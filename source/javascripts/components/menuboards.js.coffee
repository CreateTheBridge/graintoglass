...
#   $elem.find(".beer-glass-image").attr "src", image
    ...
    if item.serving_info.sized_pricing[0].size || null == 'Pint'
      console.log 'is a pint'
      $elem.find(".beer-glass-image").attr "src", 'images/pint.png'
    else if item.serving_info.sized_pricing[0].size || null == '64 oz Growler'
      $elem.find(".beer-glass-image").attr "src", 'images/growler.png'
    if item.serving_info.sized_pricing[1].size || null == '64 oz Growler'
